...
from apis import PINECONE_API_KEY, OPENAI_API_KEY
from src.configuration.pincone_operations import PineconOperation
...
if __name__ == "__main__":
    ...
    question_answering = QuestionAnswering(query="What is Data science?")
